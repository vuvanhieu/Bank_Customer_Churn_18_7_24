...
def fit_stacked_model(members, inputX, inputy):
    ...
    stackedX = stackedX.reshape((stackedX.shape[0], stackedX.shape[1], 1))
...
def main():
    ...
    model_name = "scenario_3_KNN_RF_SVM_XGB_to_RNN_Bank_Customer_Churn"
    ...
    save_metrics_to_csv(list(metrics_dict.values()), os.path.join(result_folder, 'final_metrics_scenario_3.csv'))
