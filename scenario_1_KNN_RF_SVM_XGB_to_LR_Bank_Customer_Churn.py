...
def main():
    ...
    model_name = "scenario_1_KNN_RF_SVM_XGB_to_LR_Bank_Customer_Churn"
    ...
    save_metrics_to_csv(list(metrics_dict.values()), os.path.join(result_folder, 'final_metrics_scenario_1.csv'))
